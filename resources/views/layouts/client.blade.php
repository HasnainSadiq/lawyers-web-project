...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('client.dashboard') }}"
                                :active="request()->routeIs('client.dashboard')">
                                {{ __('Dashboard') }}
                            </x-jet-nav-link>
                        </div>
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('appointment.home') }}"
                                :active="request()->routeIs('appointment.home')">
                                {{ __('Appointment') }}
                            </x-jet-nav-link>
                        </div>
                    </div>
                        ...
                        <div class="ml-3 relative">
                            <x-jet-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-jet-dropdown-link href="{{ route('profile.client-show') }}">
                                        {{ __('Profile') }}
                                    </x-jet-dropdown-link>

                                    @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                        <x-jet-dropdown-link href="{{ route('api-tokens.client-index') }}">
                                            {{ __('API Tokens') }}
                                        </x-jet-dropdown-link>
                                    @endif
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('client.home') }}"
                ...
                <div class="pt-2 pb-3 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('appointment.home') }}"
                        :active="request()->routeIs('client.home')">
                        {{ __('Appointment') }}
                    </x-jet-responsive-nav-link>
                </div>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <!-- Account Management -->
                        <x-jet-responsive-nav-link href="{{ route('profile.client-show') }}"
                            :active="request()->routeIs('profile.client-show')">
                            {{ __('Profile') }}
                        </x-jet-responsive-nav-link>

                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                            <x-jet-responsive-nav-link href="{{ route('api-tokens.client-index') }}"
                                :active="request()->routeIs('api-tokens.client-index')">
                                {{ __('API Tokens') }}
                            </x-jet-responsive-nav-link>
                        @endif
        ...
        {{-- end nav bar for client --}}


        <!-- Page Heading -->
        @if (isset($header))
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 text-center sm:px-6 lg:px-8">
                    {{ $header }}
                </div>
            </header>
        @endif
    ...
    {{-- compile js file for bootstrap start --}}
    <!-- JQuery js-->
    ...
    {{-- compile js file for bootstrap  end --}}
</body>
