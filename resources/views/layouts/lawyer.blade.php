        ...
        <nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{ route('lawyer.dashboard') }}"
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link href="{{route('lawyer.appointment')}}"
                                :active="request()->routeIs('lawyer.appointment')">
                                {{ __('Appointment') }}
                            </x-jet-nav-link>
                        </div>
                    </div>
                        ...
                        <div class="ml-3 relative">
                            <x-jet-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-jet-dropdown-link href="{{ route('profile.lawyer-show') }}">
                                        {{ __('Profile') }}
                                    </x-jet-dropdown-link>

                                    @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                        <x-jet-dropdown-link href="{{ route('api-tokens.lawyer-index') }}">
                                            {{ __('API Tokens') }}
                                        </x-jet-dropdown-link>
                                    @endif
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('lawyer.dashboard') }}"
                        :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-jet-responsive-nav-link>
                </div>
                <div class="pt-2 pb-3 space-y-1">
                    <x-jet-responsive-nav-link href="{{route('lawyer.appointment')}}"
                        :active="request()->routeIs('lawyer.appointment')">
                        {{ __('Appointment') }}
                    </x-jet-responsive-nav-link>
                </div>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        <!-- Account Management -->
                        <x-jet-responsive-nav-link href="{{ route('profile.lawyer-show') }}"
                            :active="request()->routeIs('profile.lawyer-show')">
                            {{ __('Profile') }}
                        </x-jet-responsive-nav-link>

                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                            <x-jet-responsive-nav-link href="{{ route('api-tokens.lawyer-index') }}"
                                :active="request()->routeIs('api-tokens.lawyer-index')">
                                {{ __('API Tokens') }}
                            </x-jet-responsive-nav-link>
                        @endif
